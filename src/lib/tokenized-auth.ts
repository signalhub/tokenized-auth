// нужно написать функцию, которая будет принимать строку и возвращать ее хэш
// функция должна быть асинхронной
// функция должна использовать алгоритм SHA-256
// функция должна возвращать хэш в виде строки из 64 символов
// нужно добавить описание функции jsdoc на английском языке
// пример использования:
// const hash = await sha256('hello world');
// console.log(hash); // 2ef7bde608ce5404e97d5f042f95f89f1c232871d3e93a5a
